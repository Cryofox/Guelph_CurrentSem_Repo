...
Expression 	: L_PAREN Expression R_PAREN			{ $$ = $2;}
			...
			| IDENTIFIER INCREMENT					{int i= 1; void*v=&i; $$ = operatorExpression(AssignOp,IdentifierExpression($1),operatorExpression(PlusOp,IdentifierExpression($1),ConstantExpression(v,_Int)) ); }


			| IDENTIFIER DECREMENT					{int i= 1; void*v=&i; $$ = operatorExpression(AssignOp,IdentifierExpression($1),operatorExpression(MinusOp,IdentifierExpression($1),ConstantExpression(v,_Int)) ); }

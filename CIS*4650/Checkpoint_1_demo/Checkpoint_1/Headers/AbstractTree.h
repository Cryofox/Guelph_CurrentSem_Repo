...
typedef enum {PlusOp, MinusOp, TimesOp, DivideOp, ModOp, AssignOp, SIZE_OP, EQ_OP, NE_OP, GT_OP, LT_OP, GTE_OP, LTE_OP, AND_OP,OR_OP,NOT_OP, ACCESS_OP, ARRAYACCESS_OP, RETURN_OP, None} optype;

typedef enum {_Float,_Int,_Char} vartype;

typedef enum { Expression, Function} containerType;

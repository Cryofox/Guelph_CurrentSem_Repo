...
static const char *const yytname[] =
{
  ...
  "ADD", "MIN", "MUL", "DIV", "MOD", "E", "NE", "LT", "GT", "LTE", "GTE",
  "ASSIGN", "INCREMENT", "DECREMENT", "L_PAREN", "R_PAREN", "L_BRACE",
  "R_BRACE", "MAIN", "COMA", "SEMICOLON", "CONSTANT", "KW_STRUCT",
  "KW_VOID", "KW_FLOAT", "KW_CHAR", "KW_INT", "TYPEDEF", "SIZEOF",
  "RETURN", "IF", "ELSE", "FOR", "WHILE", "$accept", "Program",
...
#line 96 "src/Parser.y" /* yacc.c:1906  */

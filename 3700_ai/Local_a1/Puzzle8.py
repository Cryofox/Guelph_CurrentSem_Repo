...
# redundant loop checking
	...
	def target_found( self ):
		...
		current state.
		"""
		print( "Solution ["+str(len(self.path))+" Moves]: " + self.path );
...
def RandomTuple():
	...
	randTuple =(index,randString,"X"*25, "_")  # This is why its slow, the construction takes into account creating a 30 Depth Graph. Changing to 25 reduces this but will
...
if __name__ == "__main__":
	...
	for i in range(1,51):
		...
		puzzle=Puzzle8(currentTuple,root=True)
		puzzle.bfs();

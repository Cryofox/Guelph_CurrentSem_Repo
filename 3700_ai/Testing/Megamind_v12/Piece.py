									...
									for x in range(0,8):
										for y in range(0,8):
											if(board[x][y]== listPoisonedUnits[j] and listPoisonedUnits[j]._isWhite != snakeList[i]._isWhite and listPoisonedUnits[j]._isWhite != (snakeList[i]._isWhite+2)):
												if((board[x][y].Get_Piece() != 'x' and board[x][y].Get_Piece() != 'X') and
												   (board[x][y].Get_Piece() != 'h' and board[x][y].Get_Piece() != 'h') and
												   (board[x][y].Get_Piece() != 't' and board[x][y].Get_Piece() != 'T') and
												   (board[x][y].Get_Piece() != 'w' and board[x][y].Get_Piece() != 'W') ):
